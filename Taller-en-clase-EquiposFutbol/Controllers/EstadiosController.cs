...
namespace Taller_en_clase_EquiposFutbol.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(Taller_en_clase_EquiposFutbolContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstadio,Direccion,Ciudad,Capacidad")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstadio,Direccion,Ciudad,Capacidad")] Estadio estadio)
        {
