...
namespace Taller_en_clase_EquiposFutbol.Controllers
{
    public class JugadorsController : Controller
    {
        private readonly Taller_en_clase_EquiposFutbolContext _context;

        public JugadorsController(Taller_en_clase_EquiposFutbolContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdJugador,NombreJugador,Posicion,Edad")] Jugador jugador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdJugador,NombreJugador,Posicion,Edad")] Jugador jugador)
        {
